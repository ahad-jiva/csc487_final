...
We first ran a baseline test with a simple model and no fancy data transformations to get baseline precision, recall, and F1 metrics. With every technique that we implemented and tested, we compared these metrics to the baseline model to see which ones (or which combinations) improved our base performance the most.
